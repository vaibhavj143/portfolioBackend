const emailHtml = (name, id) => {
  ...
  <button style="margin: 1rem auto;padding:1rem;border: 2px solid #820000; background-color:#fff;border-radius:0.5rem;" > <a style="text-decoration:none;color:#820000; " href="https://floating-depths-11719.herokuapp.com/portfolio/api/confirm/${id}">Confirm</a> </button>
